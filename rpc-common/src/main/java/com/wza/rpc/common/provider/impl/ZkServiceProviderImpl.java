package com.wza.rpc.common.provider.impl;
...
import com.wza.rpc.common.registry.ServiceRegistry;
...
public class ZkServiceProviderImpl implements ServiceProvider {
    ...
    public static final int RpcServer_PORT = 9998;
    ...
    public void publishService(RpcServiceConfig rpcServiceConfig) {
        try {
            ...
            serviceRegistry.registerService(rpcServiceConfig.getRpcServiceName(), new InetSocketAddress(host, RpcServer_PORT));
